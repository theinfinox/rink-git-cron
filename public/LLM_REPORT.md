...
*Auto-generated on: Wed, 16 Sep 2026 04:01:01 GMT*
...
- **Data Chunks:** `/api/rink_instrumentation_portal_form/{id}.json` (24 zero-token endpoints generated)
...
- `search_rink_instrumentation_portal_form`: Deep semantic search over all columns in RINK_instrumentation_portal_form.
